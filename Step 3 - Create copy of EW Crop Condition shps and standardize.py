...
input_workspace = r"G:\.shortcut-targets-by-id\18VPZbWb8nAjt-4WxSph0ngBFywVmlSeB\Crop_Condition_Paper\Archive\EW"
output_workspace = r"C:\Users\kmobley\Documents\CM4EW\Crop Patterns Paper\Preprocessing\EW_Conditions"
...
for year_folder in os.listdir(input_workspace):
    ...
    for month_folder in os.listdir(os.path.join(input_workspace, year_folder)):
        ...
        output_shapefile = os.path.join(output_workspace, "EW_{}-{}.shp".format(year, month_formatted))
        ...
        unwanted_fields = ["Trend", "Provenance", "Comment", "User", "Date_Obs", "Shape_ID", "Season", "Seasons", "Confidence", "Ass_ID", "Name_to_jo", "F14", "ADM1_NAME", "ADM0_NAME"]
